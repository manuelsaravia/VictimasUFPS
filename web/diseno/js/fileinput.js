...
(function (factory) {
    ...
    tBtnDefault = '<button type="{type}" tabindex="500" title="{title}" id="cargar" class="{css}" {status}>{icon} {label}</button>';
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgInvalidFileType: 'Extension de archivo invalida "{name}". Solo se aceptan extensiones "{types}" para los archivos a cargar.',
        msgInvalidFileExtension: 'Extension de archivo "{name}" invalida. Solo se aceptan extensiones "{extensions}" para los archivos a cargar.',
        msgUploadAborted: 'The file upload was aborted',
        msgValidationError: 'Validation Error',
        msgLoading: 'Loading file {index} of {files} &hellip;',
        msgProgress: 'Loading file {index} of {files} - {name} - {percent}% completed.',
        msgSelected: '{n} Selecciono {archivos}',
